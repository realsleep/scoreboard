...
save_btn.onclick = function() {
    event_handler_add_game_btn(name1.value, name2.value, num_matches.value, dur_match.value);
    name1.value = null;
    name2.value = null;
...
function event_handler_add_game_btn(name1_text, name2_text, num_matches_text, dur_match_text) {
...
function play(e){
    ...
    const card_rows = document.getElementById('card-' + index).childNodes[0].childNodes;
